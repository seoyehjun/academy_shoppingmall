...
public class MembersVO {
    ...
    public String getMembers_is_wirhdrwan() {
        return members_is_wirhdrwan;
    }
    public void setMembers_is_wirhdrwan(String members_is_wirhdrwan) {
        this.members_is_wirhdrwan = members_is_wirhdrwan;
    }
